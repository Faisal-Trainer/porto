    ...
    <div id="navbar"
        ...
        <div id="mobile-menu"
            ...
            <div id="dropdownMenu"
                ...
                <a class="bar-HP" href="{{ route('home') }}">Home</a>
                <a class="bar-HP" href="{{ route('about') }}">About</a>
                <a class="bar-HP" href="{{ route('portfolio') }}">Portofolio</a>
                <a class="bar-HP" href="{{ route('service') }}">Service</a>
                <a class="bar-HP" href="{{ route('contact') }}">Contact</a>
            </div>
        </div>
    </div>
</nav>
