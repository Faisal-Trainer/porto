    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6 flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Project: {{ $project->judul }}</h1>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Silakan perbarui informasi project di bawah ini.</p>
                </div>
                ...
                <form action="{{ route('admin.projects.update', $project) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="judul" id="judul" value="{{ old('judul', $project->judul) }}" placeholder="Contoh: My Awesome App" 
                        ...
                        <div>
                            ...
                            <select name="kategori" id="kategori" class="w-full rounded-xl border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-indigo-500 focus:border-indigo-500 @error('kategori') border-red-500 @enderror">
                                @php $currentKategori = old('kategori', $project->kategori); @endphp
                                <option value="web_application" {{ $currentKategori == 'web_application' ? 'selected' : '' }}>Web Application</option>
                                <option value="education" {{ $currentKategori == 'education' ? 'selected' : '' }}>Education</option>
                                <option value="social_media" {{ $currentKategori == 'social_media' ? 'selected' : '' }}>Social Media</option>
                                <option value="it_support" {{ $currentKategori == 'it_support' ? 'selected' : '' }}>IT Support</option>
                                <option value="dashboard" {{ $currentKategori == 'dashboard' ? 'selected' : '' }}>Dashboard</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_rilis" id="tanggal_rilis" value="{{ old('tanggal_rilis', $project->tanggal_rilis?->format('Y-m-d')) }}"
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="5" placeholder="Ceritakan tentang project ini..."
                                class="w-full rounded-xl border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-indigo-500 focus:border-indigo-500 @error('deskripsi') border-red-500 @enderror">{{ old('deskripsi', $project->deskripsi) }}</textarea>
                        ...
                        <div class="col-span-2">
                            ...
                            @if($project->thumbnail)
                                <div class="mb-4">
                                    ...
                                    <div class="w-48 h-32 rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 shadow-sm">
                            ...
                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-700 border-dashed rounded-xl bg-gray-50 dark:bg-gray-900">
                                <div class="space-y-1 text-center">
                                    ...
                                    <p class="text-xs text-gray-500 text-center">Biarkan kosong jika tidak ingin mengubah thumbnail.<br>PNG, JPG, GIF up to 2MB</p>
                                </div>
                            </div>
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                                @php $selectedTechs = old('technologies', $project->technologies->pluck('id')->toArray()); @endphp
