<x-app-layout>
    ...
    <section class="bg-(--color-primary-400) p-2.5 md:p-5">
        <div class="flex flex-col items-center justify-center leading-relaxed">
            <h2 class="text-xl md:text-3xl font-bold text-(--color-primary-100)">OUR SERVICE</h2>
            <span class="text-xl text-(--color-primary-100)">
                Solusi terintegrasi untuk membina talent digital dan
                mempercepat pertumbuhan UMKM secara berkelanjutan</span>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-5 gap-2.5 md:gap-4">
            <div class="card p-2 md:p-2.5">
    ...
    <section class="p-2.5 md:p-5">
        <div class="flex flex-col items-center justify-center leading-relaxed">
            <h2 class="text-xl md:text-3xl font-bold text-(--color-primary-950)">HOW I WORK</h2>
            <span class="text-xl text-(--color-primary-950)">Dari masalah bisnis hingga solusi digital yang siap
                digunakan</span>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-5 gap-2.5 md:gap-4">
            <div class="card p-2 md:p-2.5 bg-(--color-primary-300)">
                <div
                    class="bg-(--color-primary-400) text-(--color-primary-950) p-1.5 w-min border-2 rounded-full text-xl md:text-2xl">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        id="Module-Hands-Puzzle--Streamline-Ultimate" height="24" width="24">
                        <desc>
                ...
                <h3 class="text-xl md:text-2xl text-(--color-primary-950) font-bold">1.Identifikasi Masalah Bisnis</h3>
                <span>
            ...
            <div class="card p-2 md:p-2.5 bg-(--color-primary-300)">
                <div
                    class="bg-(--color-primary-400) text-(--color-primary-950) p-1.5 w-min border-2 rounded-full text-xl md:text-2xl">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        id="Cog--Streamline-Ultimate" height="24" width="24">
                        <desc>
                ...
                <h3 class="text-xl md:text-2xl text-(--color-primary-950) font-bold">2.Perencanaan</h3>
                <span>
            ...
            <div class="card p-2 md:p-2.5 bg-(--color-primary-300)">
                <div
                    class="bg-(--color-primary-400) text-(--color-primary-950) p-1.5 w-min border-2 rounded-full text-xl md:text-2xl">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        id="Lab-Tube-Experiment--Streamline-Ultimate" height="24" width="24">
                        <desc>
                        ...
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            stroke-width="1.5"></path>
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M17.25 0.75h-12"
                            stroke-width="1.5"></path>
                        ...
                        <path stroke="currentColor"
                            d="M12.375 9C12.1679 9 12 8.83211 12 8.625s0.1679 -0.375 0.375 -0.375" stroke-width="1.5">
                        </path>
                        <path stroke="currentColor"
                            d="M12.375 9c0.2071 0 0.375 -0.16789 0.375 -0.375s-0.1679 -0.375 -0.375 -0.375"
                            stroke-width="1.5"></path>
                        <path stroke="currentColor"
                            d="M10.125 13.5c-0.20711 0 -0.375 -0.1679 -0.375 -0.375s0.16789 -0.375 0.375 -0.375"
                            stroke-width="1.5"></path>
                        <path stroke="currentColor"
                            d="M10.125 13.5c0.2071 0 0.375 -0.1679 0.375 -0.375s-0.1679 -0.375 -0.375 -0.375"
                            stroke-width="1.5"></path>
                        <path stroke="currentColor"
                            d="M11.625 18c-0.2071 0 -0.375 -0.1679 -0.375 -0.375s0.1679 -0.375 0.375 -0.375"
                            stroke-width="1.5"></path>
                        <path stroke="currentColor"
                            d="M11.625 18c0.2071 0 0.375 -0.1679 0.375 -0.375s-0.1679 -0.375 -0.375 -0.375"
                            stroke-width="1.5"></path>
                    </svg>
                </div>
                <h3 class="text-xl md:text-2xl text-(--color-primary-950) font-bold">3.Solusi</h3>
                <span>
            ...
            <div class="card p-2 md:p-2.5 bg-(--color-primary-300)">
                <div
                    class="bg-(--color-primary-400) text-(--color-primary-950) p-1.5 w-min border-2 rounded-full text-xl md:text-2xl">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        id="Programming-Hold-Code-2--Streamline-Ultimate" height="24" width="24">
                        <desc>
                ...
                <h3 class="text-xl md:text-2xl text-(--color-primary-950) font-bold">4.Pengembangan</h3>
                <span>
            ...
            <div class="card p-2 md:p-2.5 bg-(--color-primary-300)">
                <div
                    class="bg-(--color-primary-400) text-(--color-primary-950) p-1.5 w-min border-2 rounded-full text-xl md:text-2xl">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        id="Laboratory-Drug-File--Streamline-Ultimate" height="24" width="24">
                        <desc>
                        ...
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            stroke-width="1.5"></path>
                        <path stroke="currentColor"
                            d="M8.82131 4.15094c-0.13498 0 -0.24441 -0.10943 -0.24441 -0.24441 0 -0.13499 0.10943 -0.24442 0.24441 -0.24442"
                            stroke-width="1.5"></path>
                        <path stroke="currentColor"
                            d="M8.82129 4.15094c0.13499 0 0.24442 -0.10943 0.24442 -0.24441 0 -0.13499 -0.10943 -0.24442 -0.24442 -0.24442"
                            stroke-width="1.5"></path>
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            d="M4.57043 8.06372h7.84677" stroke-width="1.5"></path>
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            d="M4.57043 11.5314h5.89147" stroke-width="1.5"></path>
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            d="M4.57043 14.9991h3.44725" stroke-width="1.5"></path>
                    </svg>
                </div>
                <h3 class="text-xl md:text-2xl text-(--color-primary-950) font-bold">5.Pengujian</h3>
                <span>
            ...
            <div class="card p-2 md:p-2.5 bg-(--color-primary-300)">
                <div
                    class="bg-(--color-primary-400) text-(--color-primary-950) p-1.5 w-min border-2 rounded-full text-xl md:text-2xl">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        id="Monitor-Sync--Streamline-Ultimate" height="24" width="24">
                        <desc>
                        ...
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            stroke-width="1.5"></path>
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            d="M15 18.75h-3.75v3.75" stroke-width="1.5"></path>
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                ...
                <h3 class="text-xl md:text-2xl text-(--color-primary-950) font-bold">6.Implementasi</h3>
                <span>
                    Melakukan implementasi dan deployment agar aplikasi siap digunakan di lingkungan produksi secara
                    optimal
                </span>
            </div>
        </div>
    ...
    <section class="bg-(--color-primary-400) p-2.5 md:p-5">
        <div class="flex flex-col items-center justify-center leading-relaxed">
            <h2 class="text-xl md:text-3xl font-bold text-(--color-primary-100)">ABOUT THE ECOSYSTEM</h2>
            <span class="text-xl text-(--color-primary-100)"> Menghubungkan UMKM dan talent untuk tumbuh bersama</span>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div class="mx-auto mt-6 text-(--color-primary-100)">
                <p>
                    Banyak UMKM memiliki potensi besar namun terkendala teknologi, sementara banyak talent muda
                    memiliki kemampuan namun minim pengalaman nyata.
                </p>
                <p class="mt-3">
            ...
            <div class="grid grid-cols-2 gap-2.5">
                <div class="card p-2.5 md:p-5">
                    ...
                    <span>Membina talent melalui proyek nyata, mentoring terarah, dan standar kerja industri agar siap
                        terjun ke dunia profesional</span>
                </div>
                <div class="card p-2.5 md:p-5">
                    <h3 class="text-xl md:text-2xl text-(--color-primary-950) font-bold">
                        UMKM Empowerment</h3>
                    <span>
                        Mendampingi UMKM dalam mengadopsi teknologi yang tepat guna untuk meningkatkan efisiensi,
                        branding, dan pertumbuhan bisnis.
                    </span>
                </div>
                <div class="card p-2.5 md:p-5 col-span-2">
                    <h3 class="text-xl md:text-2xl text-(--color-primary-950) font-bold">
                        Sustainable Impact</h3>
                    <span>
                        Menciptakan solusi digital yang berkelanjutan, memberi dampak jangka panjang bagi UMKM sekaligus
                        pengalaman nyata bagi talent.
                    </span>
                </div>
            </div>
        </div>
    ...
    {{-- JOIN MY CREW SECTION --}}
    <section class="p-2.5 md:p-5">
        <div class="flex flex-col items-center justify-center leading-relaxed">
            <h2 class="text-xl md:text-3xl font-bold text-(--color-primary-950)">BECOME PART OF THE ECOSYSTEM</h2>
            <span class="text-xl text-(--color-primary-950)">
                Berkolaborasi, belajar, dan tumbuh bersama dalam ekosistem UMKM & talent digital</span>
        </div>
        <h3>Ekosistem ini terbuka bagi UMKM yang ingin berkembang melalui teknologi dan talent muda yang ingin bertumbuh
            melalui pengalaman nyata.</h3>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
            <div class="card p-4">
                <h3 class="text-xl md:text-2xl text-(--color-primary-950) font-bold">Join as Talent</h3>
                <ul class="mt-3 space-y-1">
                    <li>• Proyek nyata bersama UMKM</li>
                    <li>• Mentoring & standar industri</li>
                    <li>• Pengalaman membangun portofolio</li>
                </ul>
                <a href="{{ route('talent.create') }}" class="button mt-4 inline-block">Join as Talent</a>
            </div>

            <div class="card p-4">
                <h3 class="text-xl md:text-2xl text-(--color-primary-950) font-bold">Join as UMKM</h3>
                <ul class="mt-3 space-y-1">
                    <li>• Solusi digital sesuai kebutuhan bisnis</li>
                    <li>• Pendampingan teknologi terarah</li>
                    <li>• Kolaborasi dengan talent terlatih</li>
                </ul>
                <a href="{{ route('contact.create') }}" class="button mt-4 inline-block">Join as UMKM</a>
            </div>
        </div>
    </section>
