<x-app-layout>
    @section('title', 'Blog Web Development & SEO UMKM Bukittinggi | Faisal Yusra Web Developer Bukittinggi')
    ...
    @section('og_title', 'Blog Web Development & SEO UMKM Bukittinggi | Faisal Yusra Web Developer Bukittinggi')
    @section(
        'og_description',
    ...
    @section('twitter_title', 'Blog Web Development & SEO UMKM Bukittinggi | Faisal Yusra Web Developer Bukittinggi')
    @section(
        'twitter_description',
