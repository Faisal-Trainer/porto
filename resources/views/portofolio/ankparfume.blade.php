<x-app-layout>
    ...
    @section('meta_description', 'Detail studi kasus ANK Parfume yang mengeksplorasi transisi dari model bisnis
        tradisional ke platform digital modern.')
    ...
    @section('twitter_image', asset('img/logo/ankparfume.webp'))
        ...
        <section class="p-2.5 md:p-5">
            ...
            <div class="p-2.5 max-w-2xl text-(--color-primary-700) space-y-4">
                <p class="text-base md:text-lg leading-relaxed">
                    Studi ini mengamati bagaimana sebuah brand retail lokal seperti <strong>ANK Parfume</strong> dapat
                    memanfaatkan teknologi web untuk memperluas jangkauan pasar dan meningkatkan efisiensi operasional.
                </p>
            </div>
            ...
            <div class="relative z-10 w-full flex flex-col items-center mt-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full px-5">
                    ...
                    <div class="card-web p-6 rounded-3xl" style="--accent:#f59e0b; --shadow:#2d2d2d">
                        <div
                            class="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-xl mb-4">
                            🌐</div>
                        <h2 class="font-['Syne'] text-xl font-black text-(--accent) mb-2">Web 1.0</h2>
                        <p class="text-xs text-(--accent) opacity-70 mb-4">Katalog wangi statis yang fokus pada
                            kejelasan informasi aroma.</p>
                        <a href="#web10" class="text-xs font-bold text-(--accent) group">Selengkapnya <span
                                class="group-hover:pl-2 transition-all">→</span></a>
                    </div>
                    ...
                    <div class="card-web p-6 rounded-3xl" style="--accent:#f59e0b; --shadow:#2d2d2d">
                        ...
                        <p class="text-xs text-(--accent) opacity-70 mb-4">Sistem pemesanan online dengan fitur review
                            dan profil pelanggan.</p>
                        <a href="#web20" class="text-xs font-bold text-(--accent) group">Selengkapnya <span
                                class="group-hover:pl-2 transition-all">→</span></a>
                    </div>
                    ...
                    <div class="card-web p-6 rounded-3xl" style="--accent:#f59e0b; --shadow:#2d2d2d">
                        ...
                        <p class="text-xs text-(--accent) opacity-70 mb-4">Pengalaman belanja secepat aplikasi mobile
                            lewat browser (PWA).</p>
                        <a href="#web25" class="text-xs font-bold text-(--accent) group">Selengkapnya <span
                                class="group-hover:pl-2 transition-all">→</span></a>
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div class="reveal">
                ...
                <p class="text-xl text-white/70 mb-8 leading-relaxed">
                    Menampilkan daftar ketersediaan wangi parfume secara statis. Mirip seperti papan pengumuman digital
                    yang tidak bisa dipesan langsung.
                </p>
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div class="order-1 md:order-2 reveal">
                ...
                <p class="text-xl text-black/70 mb-8 leading-relaxed">
                    Implementasi keranjang belanja, integrasi WhatsApp, dan sistem login untuk melihat riwayat pembelian
                    pelanggan setia ANK Parfume.
                </p>
                <div class="flex gap-4">
                    <div class="px-5 py-3 rounded-xl bg-black/5 border border-black/10 font-bold">🛒 Cart System</div>
                    <div class="px-5 py-3 rounded-xl bg-black/5 border border-black/10 font-bold">💬 WA Integration
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="p-8 rounded-3xl bg-white/5 border border-white/10 reveal">
                    ...
                    <p class="text-white/50 text-sm">PWA yang bisa diakses langsung dari home screen tanpa download App
                        Store.</p>
                </div>
                <div class="p-8 rounded-3xl bg-white/5 border border-white/10 reveal delay-2">
                    ...
                    <p class="text-white/50 text-sm">Optimasi aset gambar parfume dengan format WebP untuk loading < 1
                            detik.</p>
                </div>
                <div class="p-8 rounded-3xl bg-white/5 border border-white/10 reveal delay-3">
                    ...
                    <p class="text-white/50 text-sm">Keamanan data pelanggan yang terenkripsi dan sesuai standar modern.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section id="web30" class="py-24 px-5 bg-white text-center border-b border-gray-100">
        <div class="max-w-2xl mx-auto reveal">
            ...
            <p class="text-gray-500 leading-relaxed mb-10">
                Membangun ekosistem loyalitas berbasis NFT: "Scent Token" yang bisa dikumpulkan oleh pelanggan untuk
                ditukar dengan parfume fisik eksklusif.
            </p>
    ...
    <section class="py-12 px-5 md:px-20 bg-gray-50">
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            <a href="{{ route('warungsiyas') }}"
                class="group p-8 rounded-2xl bg-white border border-gray-200 hover:border-amber-500 transition-all shadow-sm flex items-center gap-6">
                <div
                    class="w-16 h-16 rounded-xl overflow-hidden shrink-0 grayscale group-hover:grayscale-0 transition duration-500">
            ...
            <a href="{{ route('portfolio') }}"
                class="group p-8 rounded-2xl bg-white border border-gray-200 hover:border-amber-500 transition-all shadow-sm flex md:flex-row-reverse items-center gap-6 md:text-right">
    ...
    <section class="py-20 px-5 bg-(--color-primary-950) text-center relative">
        <div class="relative z-10">
            ...
            <a href="{{ route('contact.create') }}"
                class="inline-block bg-amber-500 text-primary-900 font-black px-12 py-5 rounded-2xl hover:bg-amber-600 transition shadow-xl shadow-amber-500/10">
