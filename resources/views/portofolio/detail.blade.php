<x-app-layout>
    @foreach ($projects as $project)
        ...
        @section('meta_keywords', $project->kategori)
        @section('canonical', url()->current())

        @section('og_title', $project->judul . '- Studi Evolusi Web 1.0, 2.0, 2.5 & 3.0 | Faisal Yusra')
        ...
        <header id="hero">
            <section class="p-2.5 md:p-5">
                ...
                <p class="text-sm md:text-base text-(--color-accent-500) reveal delay-2 p-2.5">
                    Eksplorasi {{ $project->judul }} dalam tiga pendekatan web: <br>
                ...
                <div class="relative z-10 w-full flex flex-col items-center ">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-225 w-full">
                        ...
                        <div class="card-web p-2 md:p-5 rounded-2xl md:rounded-3xl"
                            ...
                            <p class="text-base leading-[1.65] text-(--accent) font-light mb-5">
                                Pendekatan hybrid modern dengan Laravel, Livewire, dan reactive UI — terbaik dari dua
                                dunia.
                            </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div class="reveal delay-3">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <!-- Keunggulan -->
                            <div
                                class="rounded-2xl border border-white/20 bg-white/10 backdrop-blur-md p-2.5 md:p-5 mb-6">
                                <h3 class="text-xl/normal font-bold mb-4 uppercase text-(--color-primary-400)">
                                    ✓ Keunggulan
                                </h3>
                                <ul role="list" style="list-style: none">
                                    <li
                                        class="gap-3 py-2.5 text-(--color-primary-100) text-base/normal flex items-start">
                                        <span
                    ...
                    <div class="reveal delay-3">
                        ...
                        <span class="text-base/relaxed text-(--color-accent-500) font-semibold mb-3">
                            Klik preview di atas untuk membuka simulasi Web 1.0. Demo ini menampilkan bagaimana website
                            yang
